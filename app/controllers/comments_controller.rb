class CommentsController < ApplicationController
  ...
  def create
    @shott = Shott.find(params[:shott_id]) # finds the shot with the associated shot_id
    @comment = @shott.comments.create(comment_params) # creates the comment on the shot passing in params
